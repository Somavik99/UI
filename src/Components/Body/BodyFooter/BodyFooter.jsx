    ...
    <>
      <div className="w-[100%] overflow-x-hidden relative flex justify-center items-center flex-row h-[1500px] top-[50em] border-2 bg-black border-black z-50">
        ...
        <img
          ...
          alt="Camera"
          className="w-[1050px] z-[150] rounded-2xl absolute mt-[50%] bottom-96 origin-center  "
        />
        <img
          src={Travel}
          alt="Travel"
          onClick={CaptureImage}
          className="mt-[50%] w-[1050px] absolute left-10 bottom-72 rounded-2xl origin-center rotate-[-45deg] z-[100] "
        />
        <img
          src={Compass}
          alt="Compass"
          onClick={CaptureImage}
          className="mt-[50%] w-[1050px] z-[100] absolute bottom-72 right-10 rounded-2xl origin-center rotate-[35deg]"
        />
      </div>
    </>
  );
